...
const createAuditoria = async (req, res) => {
  const { accion, tabla, id_usuario, id_rol, details } = req.body;
  try {
    const result = await pool.query(
      'INSERT INTO auditoria (accion, tabla, id_usuario, id_rol, details) VALUES ($1, $2, $3, $4, $5) RETURNING *',
      [accion, tabla, id_usuario, id_rol, details]
    );
